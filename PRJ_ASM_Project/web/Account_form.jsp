        ...
        <div id="app">
            ...
            <div id="main">
                ...
                <div class="page-heading">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row align-items-center">
                                                        ...
                                                        <div class="col-lg-10 col-9">
                                                            <input type="password" id="helperText" class="form-control" name="password"
                    ...
                    <a href="account?aindex=1"><button class="btn btn-outline-danger" style="padding-top: 10px; padding-bottom: 10px; margin-bottom: 20px;"><i
                                style="margin-right: 5px;">
                            </i>Hủy bỏ</button>
                    </a>
                    <footer>
                        <div class="footer clearfix mb-0 text-muted">
                            <div class="float-start">
                                <p>14/3/2022 &copy; Quàn lý sinh viên</p>
                            </div>
                            <div class="float-end">
