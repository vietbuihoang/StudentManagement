        ...
        <div id="app">
            ...
            <div id="main">
                ...
                <div class="page-heading">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row align-items-center">
                                                        ...
                                                        <div class="col-lg-10 col-9">
                                                            <input type="text" id="helperText" class="form-control" name="makhoa"
                                                                   placeholder="Mã Khoa">
                    ...
                    <a href="khoa?kindex=1"><button class="btn btn-outline-danger" style="padding-top: 10px; padding-bottom: 10px; margin-bottom: 20px;"><i
                                style="margin-right: 5px;">
                            </i>Hủy bỏ</button>
                    </a>
                    <footer>
