        ...
        <div id="app">
            ...
            <div id="main">
                ...
                <div class="page-heading">
                    ...
                    <form action="monhoc_update" method="post">
                                                    ...
                                                    <div class="form-group row align-items-center">
                                                        ...
                                                        <div class="col-lg-10 col-9">
                                                            <input type="text" id="last-name" class="form-control" name="id"
                                                                   placeholder="ID" value="${mh.id}" readonly ="readonly">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group row align-items-center">
                                                        ...
                                                        <div class="col-lg-10 col-9">
                                                            <input type="text" id="last-name" class="form-control" name="tenMH"
                                                                   placeholder="Tên môn học" value="${mh.tenMH}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group row align-items-center">
                                                        ...
                                                        <div class="col-lg-10 col-9">
                                                            <input type="text" id="first-name" class="form-control" name="maMH"
                                                                   placeholder="Mã môn học" value="${mh.maMH}" readonly ="readonly">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group row align-items-center">
                                                        ...
                                                        <div class="col-lg-10 col-9">
                                                            <input type="text" id="last-name" class="form-control" name="tinchi"
                                                                   placeholder="Số tín chỉ" value="${mh.tinChi}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <a href="monhoc?mindex=1"><button class="btn btn-outline-danger" style="padding-right: 20px;padding-left: 20px;padding-top: 10px; padding-bottom: 10px; margin-bottom: 20px;"><i
                                style="margin-right: 5px;">
                            </i>Hủy bỏ</button>
                    </a>
                    <footer>
