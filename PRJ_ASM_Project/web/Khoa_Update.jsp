        ...
        <div id="app">
            ...
            <div id="main">
                ...
                <div class="page-heading">
                    ...
                    <form action="khoa_update" method="post">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row align-items-center">
                                                        ...
                                                        <div class="col-lg-10 col-9">
                                                            <input type="text" id="first-name" class="form-control" name="mak"
                                                                   placeholder="Mã Khoa" value="${kh.maKhoa}" readonly ="readonly">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group row align-items-center">
                                                        ...
                                                        <div class="col-lg-10 col-9">
                                                            <input type="text" id="last-name" class="form-control" name="tenk"
                                                                   placeholder="Tên Khoa" value="${kh.tenKhoa}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group row align-items-center">
                                                        ...
                                                        <div class="col-lg-10 col-9">
                                                            <input type="text" id="first-name" class="form-control" name="dchi"
                                                                   placeholder="Địa chỉ" value="${kh.diaChi}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group row align-items-center">
                                                        ...
                                                        <div class="col-lg-10 col-9">
                                                            <input type="text" id="last-name" class="form-control" name="dthoai"
                                                                   placeholder="Điện thoại" value="${kh.dienThoai}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <div>
                        <a href="khoa?kindex=1"><button class="btn btn-outline-danger" style="padding-right: 20px;padding-left: 20px;padding-top: 10px; padding-bottom: 10px; margin-bottom: 20px;"><i
                                    style="margin-right: 5px;">
                                </i>Hủy bỏ</button>
                        </a>
                    </div>
