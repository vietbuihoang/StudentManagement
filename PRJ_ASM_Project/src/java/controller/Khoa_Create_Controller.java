 ...
 * @author admin
 */
@WebServlet(name = "Khoa_Create_Controller", urlPatterns = {"/khoa_create"})
public class Khoa_Create_Controller extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        request.getRequestDispatcher("Khoa_form.jsp").forward(request, response);
    }
